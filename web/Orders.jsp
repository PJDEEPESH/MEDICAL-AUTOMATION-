        ...
        <div class="header">
            <div class="container2">
                <div class="navbar">
                    ...
                    <a href="DownloadBill.jsp">Download Bill Receipt</a>
                </div>
            </div>
        </div>
    </div>
    <div class="active">
        ...
        <table class="tables">
            ...
            <tr>
                ...
                <td>
                    <%
                        Timestamp orderDateTime = rs.getTimestamp("orderdatetime");
                        if (orderDateTime != null) {
                            out.print(orderDateTime);
                        } else {
                            out.print("13-01-2024"); // Or any default value you want to display for null timestamps
                        }
                    %>
                </td>
            </tr>
            <%
                totalAmount += rs.getInt("price") * rs.getInt("quantity"); // Accumulate totalAmount
                }
            %>
        </table>
